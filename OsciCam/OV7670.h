...
class OV7670: public I2SCamera
{
  ...
  static const int ResolutionValues[][2];

  typedef const unsigned char (*RegisterList)[2];

  static const unsigned char VGARegisters[][2];
  static const unsigned char QVGARegisters[][2];
  static const unsigned char QQVGARegisters[][2];
  static const unsigned char QQQVGARegisters[][2];
  static const RegisterList ResolutionRegisters[];

  static const unsigned char YUVRegisters[][2];
  static const unsigned char RGB565Registers[][2];
  static const RegisterList ColorFormatRegisters[];
  ...
  public:
  OV7670(OV7670::Resolution r, OV7670::ColorFormat c, const int SIOD, const int SIOC, const int VSYNC, const int HREF, const int XCLK, const int PCLK, const int D0, const int D1, const int D2, const int D3, const int D4, const int D5, const int D6, const int D7);
